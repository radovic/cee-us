# only fully abstract types should go here. Every thing with
# implementation goes one down in the hierarchy
...
class Controller(ABC):
    ...
    def __init__(self, *, env: Env):
        self.env = env
        self.num_envs = (env.num_envs if env.num_envs else 1) if env else None
